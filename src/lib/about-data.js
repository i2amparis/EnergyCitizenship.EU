...
let energy_access = [
    {
        ...
        description: 'Those who are prevented from connecting to energy grids due to socio-political and/or economic reasons or in terms of geographical location.'
    },
    {
        name: 'Dispossessed',
        imageUrl: access_dispossesed_icon,
        description: 'Indigenous people and other marginalized groups from whom energy resources have been unjustly taken e.g., tar sands production on Canadian First Nations land and/or extraction schemes which have resulted in their displacement, e.g., Three Gorges Dam in China.'
    },
    {
        name: 'Energy poor',
        imageUrl: access_poor_icon,
        description: 'Households unable to afford the energy needed for essential energy services. Income is important, but there is not a direct link. Not all those who suffer from monetary poverty are necessarily energy poor. Also, not all those in energy poverty are income poor. \n \
        \n \
        A complex multidimensional issue that encompasses a broad range of factors including energy services provision, the quality of the service being provided, reliability of supply, and affordability.'
    }
];
...
let energy_consumption = [
    ...
    },
    {
        ...
        description: 'An energy literate consumer able and willing to provide peer support to other consumers around energy savings. Typically, they will be environmentally conscious and technically minded. They may be thrifty, but their motivation for reducing energy consumption is not just about money. Their energy conservator role often results from an anti-consumerism philosophy.'
    },
    {
